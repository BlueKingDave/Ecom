...
export function Layout() {
    ...
    return (_jsxs("div", { className: "min-h-screen flex", children: [_jsx("a", { href: "#main-content", className: "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-primary focus:text-primary-foreground focus:rounded-md", children: "Skip to main content" }), sidebarOpen && (_jsx("div", { className: "fixed inset-0 bg-black/50 z-40 lg:hidden", onClick: () => setSidebarOpen(false), "aria-hidden": "true" })), _jsxs("aside", { className: cn('w-64 bg-card border-r transition-transform duration-300 ease-in-out z-50', 'fixed inset-y-0 left-0 lg:static lg:translate-x-0', sidebarOpen ? 'translate-x-0' : '-translate-x-full'), children: [_jsxs("div", { className: "flex items-center justify-between p-6 lg:block", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold", children: "Admin Dashboard" }), _jsx("p", { className: "text-sm text-muted-foreground", children: "Ecom Platform" })] }), _jsx("button", { className: "lg:hidden p-2 hover:bg-accent rounded-md transition-colors", onClick: () => setSidebarOpen(false), "aria-label": "Close menu", children: _jsx(X, { className: "h-5 w-5" }) })] }), _jsx("nav", { className: "px-4 space-y-1", children: navItems.map(({ path, label, icon: Icon }) => {
